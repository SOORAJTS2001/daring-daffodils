...
window.toggleConnectionMode = function() {
    chrome.runtime.sendMessage({type: "toggle_connection"}, (response) => {
        if (response) {
            ...
            console.log("Content: No response from background script");
        }
    });
};
...
window.checkStatus = function() {
    chrome.runtime.sendMessage({type: "get_status"}, (response) => {
        if (response) {
            console.log("Content: Background script status:", response);
        } else {
            console.log("Content: No response from background script");
        }
    });
...
console.log("Content: Use toggleConnectionMode() to switch connection modes");
console.log("Content: Use checkStatus() to check background script status");
console.log("Content: Use startFirebaseFallback() for emergency Firebase mode.");
